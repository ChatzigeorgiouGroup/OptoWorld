...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setMaximumSize(QtCore.QSize(200, 600))
        ...
        self.horizontalLayout.addWidget(self.slider_light)
        ...
        self.verticalLayout_2.addWidget(self.button_lightswitch)
        ...
        self.gridLayout.addWidget(self.framePlotWidget, 0, 1, 2, 1)
