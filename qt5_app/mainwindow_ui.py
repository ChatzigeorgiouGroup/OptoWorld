...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_lightswitch = QtWidgets.QPushButton(self.centralwidget)
        self.button_lightswitch.setCheckable(False)
        self.button_lightswitch.setObjectName("button_lightswitch")
        self.gridLayout.addWidget(self.button_lightswitch, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "periodic"))
